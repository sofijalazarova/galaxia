        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Galaxia</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-white">Socials</h2>
                  <ul class="dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a className="text-white" href="#" class="hover:underline">Facebook</a>
                      </li>
                      <li>
                          <a className="text-white" href="#" class="hover:underline">Instagram</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a className="text-white" href="#" class="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a className="text-white" href="#" class="hover:underline">Discord</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul class="dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a className="text-white" href="#" class="hover:underline">Privacy Policy</a>
                      </li>
                      <li>
                          <a className="text-white" href="#" class="hover:underline">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
